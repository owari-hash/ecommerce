...
const SERVICES: { href: string; label: string; sub: string; Icon: LucideIcon; image: string }[] = [
  {
    ...
    Icon: ClipboardList,
    image: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1400&auto=format&fit=crop&q=90',
  },
  {
    href: '/delivery',
    label: 'Хүргэлт',
    sub: 'Хаана ч хүргэнэ',
    Icon: Truck,
    image: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=1400&auto=format&fit=crop&q=90',
  },
  {
    href: '/contact',
    label: 'Холбоо барих',
    ...
    Icon: Phone,
    image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1400&auto=format&fit=crop&q=90',
  },
  {
    href: '/warranty',
    ...
    Icon: Wrench,
    image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1400&auto=format&fit=crop&q=90',
  },
  {
    href: '/installation',
    label: 'Суурилуулалт',
    ...
    Icon: Monitor,
    image: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=1400&auto=format&fit=crop&q=90',
  },
  {
    href: '/payment',
    ...
    Icon: Lock,
    image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=1400&auto=format&fit=crop&q=90',
  },
];
