            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {activeBrands.map((b) => (
                <button
                  key={b}
                  type="button"
                  className="px-3 py-1.5 rounded-full bg-blue-50 text-primary border border-blue-100 text-xs font-bold"
          ...
          {filtered.map((p) => (
            ...
            >
              ...
              <div className="p-3">
                ...
                <button
                  type="button"
                  className="mt-3 w-full bg-primary hover:bg-primary-dark text-white text-xs font-black py-2 rounded-xl"
                  onClick={(e) => {
                    e.preventDefault();
                  }}
                >
