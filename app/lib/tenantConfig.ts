  ...
  foodcity: {
    ...
    theme: {
      ...
      homepageSections: [
        ...
        { type: 'ProductGrid', props: { title: 'Өнөөдрийн санал', isSale: true, limit: 12 } },
        { type: 'ProductGrid', props: { title: 'Бүх бараа', limit: 12 } },
  ...
  'goto-market': {
    ...
    theme: {
      ...
      homepageSections: [
        ...
        { type: 'CategoryList', props: {} },
        { type: 'ProductGrid', props: { title: 'Шинэ ирэлт', isNew: true, limit: 12 } },
        { type: 'ProductGrid', props: { title: 'Хямдралтай санал', isSale: true, limit: 12 } },
        { type: 'ProductGrid', props: { title: 'Бүх бараа', limit: 12 } },
        { type: 'BrandList', props: {} },
      ],
    },
